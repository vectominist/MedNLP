...
if __name__ == '__main__':
    ...
    parser.add_argument('--risk-path', type=str,
                        help='Path to risk data (.csv)')
    parser.add_argument('--meddg-path', type=str, default='',
                        help='Path to MedDG data (.pk)')
    parser.add_argument('--meddia-path', type=str, default='',
                        help='Path to Medical Dialogue data (.json)')
    ...
    meddg_utts = [] if args.meddg_path == '' else read_MedDG_data(
        args.meddg_path)
    print('Found {} utterances from {}'.format(
        len(meddg_utts), args.meddg_path))
    meddia_utts = [] if args.meddia_path == '' else read_MedicalDialogue_data(
        args.meddia_path)
    print('Found {} utterances from {}'.format(
        len(meddia_utts), args.meddia_path))
